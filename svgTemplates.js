...
function style1({ count, bg = "#4c51bf", textColor = "#ffffff" }) {
...
<svg xmlns="http://www.w3.org/2000/svg" width="${width}" height="30" role="img" aria-label="${label}">
  <rect width="${width}" height="30" fill="${safeBg}" rx="4" />
...
function style2({ count, bg = "#0ea5e9", textColor = "#0b1220" }) {
...
function style3({ count, bg = "#10b981", textColor = "#00312a" }) {
...
<svg xmlns="http://www.w3.org/2000/svg" width="${width}" height="32">
  ...
  <rect x="2" y="2" width="${width - 4}" height="28" fill="${safeBg}" rx="5" />
...
function style4({ count, bg = "#f59e0b", textColor = "#1f1300" }) {
...
<svg xmlns="http://www.w3.org/2000/svg" width="${width}" height="34">
  ...
  <rect width="${width}" height="34" fill="${safeBg}" rx="8" filter="url(#shadow)" />
  <text x="16" y="22" fill="${safeText}" font-size="14" font-family="Verdana, Geneva, Tahoma, sans-serif">${label}</text>
</svg>`;
}

function style5({ count, bg = "#ef4444", textColor = "#ffffff" }) {
